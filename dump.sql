...
ALTER TABLE "question_tags" ADD CONSTRAINT "question_tags_fk0" FOREIGN KEY ("question_id") REFERENCES "questions"("id");
ALTER TABLE "question_tags" ADD CONSTRAINT "question_tags_fk1" FOREIGN KEY ("tag_id") REFERENCES "tags"("id");
